...
const PeriodVertical = () => {
  ...
  useEffect(() => {
    ...
    //     setImages([
    //       ...entity.secondLevel.sources.map((source) =>
    //         source.about.images.map((item) => {
    //           return {
    ...
    //       ...entity.secondLevel.sources.map((source) => {
    //         return {
    //           name: new URL(source.about.main.img).origin,
    //           url: source.about.main.img
    //         }
    //       })
    //     ])
    //     console.log('успешно')
  ...
  return (
    <form>
      <div className={classes.container}>
        ...
        {/*              <SingleImageForm image={mainImage[index]} setImage={setMainImage} />*/}
        {/*            </div>*/}
        {/*            <TextField*/}
        {/*              value={source.about.number}*/}
        ...
        {/*            />*/}
        {/*            <TextField*/}
        {/*              value={source.about.main.title}*/}
        {/*              onChange={(e) =>*/}
        {/*                dispatch(setSecondLevelSourcesAboutMainTitle(e.target.value))*/}
        {/*              }*/}
        {/*              label="Заголовок"*/}
        {/*              variant="outlined"*/}
        {/*            />*/}
        ...
        {/*        <h3>Галерея</h3>*/}
        {/*        <div className={classes.container__inputList}>*/}
        {/*          <MultipleImageForm images={images[index]} setImages={setImages} />*/}
        {/*        </div>*/}
        {/*      </SimpleCard>*/}
        {/*    </>*/}
        {/*  )*/}
